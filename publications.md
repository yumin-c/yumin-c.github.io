...
- **Cheong Y**, Choi Y, Kim HK, Kim HH. DeepPrime7: Predicting PE7 Prime Editing Efficiency Across PAM Variants. *ICLR 2026 Workshop on Generative and Experimental Perspectives for Biomolecular Design*.
...
- Designed and delivered the **MARS PyTorch Tutorial** lecture.
- Led team project ***Understanding EEG*** to predict individualized VNS treatment effects in epileptic seizure patients.
